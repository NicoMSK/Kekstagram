    ...
    <>
      <main>
        ...
        <section className="img-filters  img-filters--inactive  container">
          <h2 className="img-filters__title  visually-hidden">
            Фильтр фотографий
          </h2>
          <form
      ...
      <footer className="page-footer  container">
        <div className="page-footer__wrapper">
          <ul className="page-footer__contacts  contacts">
            <li>
              <a className="contacts__link  contacts__link--twitter" href="#">
                Twitter
              </a>
            </li>
            <li>
              <a className="contacts__link  contacts__link--vk" href="#">
                VK
              </a>
            </li>
          </ul>
      ...
      <template id="data-error">
        <section className="data-error">
          <h2 className="data-error__title">Не удалось загрузить данные</h2>
        </section>
      </template>
    </>
  );
